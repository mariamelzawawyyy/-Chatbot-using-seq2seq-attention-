...
class Encoder(nn.Module):
    def __init__(self, vocab_size, embedding_size, hidden_size, num_layers, padding_index, dropout=0.3):
        super().__init__()
...
class Decoder(nn.Module):
    def __init__(self, embedding_size, input_size, output_size, hidden_size, num_layers, attention_size, dropout=0.3):
        super().__init__()
