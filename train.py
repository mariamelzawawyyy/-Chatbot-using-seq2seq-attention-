...
from main import vocab, PAD_IDX, SOS_IDX, EOS_IDX, UNK_IDX, train_loader, val_loader, glove_weights
...
print(f"Starting Training with GloVe 2024 | Vocab Size: {vocab_size}")
...
for epoch in range(1, num_epochs + 1):
    ...
    for inputs, targets in train_loader:
        ...
        # تجاهل أول كلمة (SOS) في حساب الـ Loss
    ...
    print(f"Epoch [{epoch}/{num_epochs}] | TF: {tf_ratio:.2f} | Train Loss: {avg_train_loss:.4f} | Val Loss: {avg_val_loss:.4f} | {status}")
